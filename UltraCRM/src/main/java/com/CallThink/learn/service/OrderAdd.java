...
public class OrderAdd extends UltraCRM_Page{
 	...
 	public void myToolBar_btnItemClick(Object sender, String name, String parms, int nparms) 
     {
       String strResult = "FAIL";
        ...
        if (name.equals("Save"))
        {
            ...
            Functions.ht_SaveEx("LOGIN_NAME", myFld.get_item_text("LOGIN_NAME"), htOpidk);
            Functions.ht_SaveEx("LOGIN_NAME", myFld.get_item_text("LOGIN_NAME"),  htOpidk);
            ...
            Functions.ht_SaveEx("MOBILENO", myFld.get_item_text("MOBILENO"),  htOpidk);
            Functions.ht_SaveEx("TEL", myFld.get_item_text("TEL"),  htOpidk);
            Functions.ht_SaveEx("ADDR", myFld.get_item_text("ADDR"),  htOpidk);
            Functions.ht_SaveEx("MEMO", myFld.get_item_text("MEMO"),  htOpidk);
            Functions.ht_SaveEx("LAST_PWD_DATE", DateTime.NowString("yyyy-MM-dd HH:mm:ss"),  htOpidk);
            Functions.ht_SaveEx("PASS", Functions.strItem_toBase64(myFld.get_item_text("PASS")),  htOpidk);
